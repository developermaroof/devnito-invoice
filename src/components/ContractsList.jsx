                          ...
                          <table className="min-w-full divide-y divide-gray-200">
                            ...
                            {invoices.map((invoice) => (
                                <tr key={invoice.id} className="bg-white">
                                  ...
                                  <td className="whitespace-nowrap min-w-[100px] min-h-[100px]   px-6 text-right text-sm text-gray-500">
                                    <span className="font-medium text-gray-900">{invoice.projectBudget}</span>
                                  </td>
                                  <td className="hidden min-w-[100px] min-h-[50px] whitespace-nowrap px-6 py-4 text-sm text-gray-500 md:block">
